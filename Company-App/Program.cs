...
static void Menus()
{
    ...
    while (true)
    {
        ...
        {
            ConsoleColor.DarkBlue.WriteConsole("Department option:\n" +
                "1.Create\n");
            FirstOption: string firstOptionStr = Console.ReadLine();
            int firstOption;
            bool isParseFirstOption = int.TryParse(firstOptionStr, out firstOption);

            if (!isParseFirstOption)
            {
